...
class Order(models.Model):
    ...
    berries = models.ForeignKey(Berries, verbose_name='Ягоды', on_delete=models.CASCADE, blank=True, null=True, default=0)
    decor = models.ForeignKey(Decor, verbose_name='Декор', on_delete=models.CASCADE, blank=True, null=True, default=0)
    inscription = models.CharField(max_length=200, verbose_name='Надпись', blank=True, null=True,default=0)
